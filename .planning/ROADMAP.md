...
- [x] 02-03-dimensions-PLAN.md — 4 banded scorers (collateral, contract, oracle, liquidity) + synthesize() combiner (REQ-01)
- [x] 02-04-claude-hash-PLAN.md — single-shot Anthropic tool-use synthesis + RFC 8785 JCS hash + 3 golden tests (REQ-01)
- [x] 02-05-cli-e2e-PLAN.md — rate() orchestrator + pnpm rate CLI + post-hoc citation validation + env-safety + human-verify (REQ-01, REQ-05)
